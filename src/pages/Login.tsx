...
import { Eye, EyeOff, LogIn, Car, ArrowLeft, Mail, Lock } from "lucide-react";
        ...
        <div className="relative z-10 flex flex-col justify-between p-12">
          ...
          <div>
            ...
            <p className="text-white/60 text-lg max-w-md">
              Access your account to manage your favorites, track inquiries, and explore our exclusive inventory.
            </p>
          </div>

          <div className="flex items-center gap-4 text-white/40 text-sm">
            <span>Trusted by 1,800+ clients</span>
            <span className="w-1 h-1 rounded-full bg-gold" />
            <span>Premium car marketplace</span>
          </div>
        </div>
      </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="relative py-4">
              ...
              <div className="relative flex justify-center">
                <span className="bg-dark px-4 text-white/40 text-sm">or continue with</span>
              </div>
            </div>
